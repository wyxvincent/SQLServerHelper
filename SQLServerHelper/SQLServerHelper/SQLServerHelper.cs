...
namespace SQLServerHelper
{
    public class SQLServerHelper
    {
        ...
        /* 取datatable */
        /// <summary>
        /// Obtain a DataTable by SQL
        /// </summary>
        /// <param name="sError">Error Message</param>
        /// <param name="sSQL">SQL Command (SELECT)</param>
        ...
        /* 取最大的ID */
        /// <summary>
        /// Obtain the maximum number of a specific column in a table.
        /// </summary>
        /// <param name="sError">Error Message</param>
        /// <param name="sKeyField">The column name</param>
        ...
        /// <param name="bUseTransaction">Use Transaction or not</param>
